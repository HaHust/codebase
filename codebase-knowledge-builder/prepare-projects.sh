...
SOURCE_ROOT="${CODEBASE_SOURCE_ROOT:-/home/ha/Documents/myData/sourceCode}"
KNOWLEDGE_ROOT="${CODEBASE_KNOWLEDGE_ROOT:-/home/ha/.codex/projects}"
CODEGRAPH_BIN="${CODEGRAPH_BIN:-/home/ha/.local/bin/codegraph}"
